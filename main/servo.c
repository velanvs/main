 ...
 */
 ...
 #define SERVO_PULSE_GPIO             16        // GPIO connected to the PWM signal line
 ...
 void servo_task(void *pvParameters)
 {
     ...
     // Set the initial compare value (servo at center position)
     ...
     while (1) {
       //  ESP_LOGI(TAG, "Angle of rotation: %d", angle);
         ...
         // Add delay, since it takes time for the servo to rotate
 ...
 {
     // Create the FreeRTOS task for the servo
